...
function runBaseTests() {
  px_demo_helpers_1 = document.getElementById('px_demo_helpers_1');

  suite('Base Automation Tests for px-demo-helpers', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-demo-helpers fixture is created', function() {
      assert.isTrue(document.getElementById('px_demo_helpers_1') !== null);
    });
